...
// ../../../DeskThing-NPM/Server/node_modules/delayed-stream/lib/delayed_stream.js
var require_delayed_stream2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/delayed-stream/lib/delayed_stream.js"(exports2, module2) {
    var Stream = require("stream").Stream;
    var util2 = require("util");
    module2.exports = DelayedStream;
    function DelayedStream() {
...
// ../../../DeskThing-NPM/Server/node_modules/combined-stream/lib/combined_stream.js
var require_combined_stream2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/combined-stream/lib/combined_stream.js"(exports2, module2) {
    var util2 = require("util");
    var Stream = require("stream").Stream;
...
// ../../../DeskThing-NPM/Server/node_modules/mime-db/db.json
var require_db2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/mime-db/db.json"(exports2, module2) {
    module2.exports = {
      "application/1d-interleaved-parityfec": {
        source: "iana"
      },
...
// ../../../DeskThing-NPM/Server/node_modules/mime-db/index.js
var require_mime_db2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/mime-db/index.js"(exports2, module2) {
    module2.exports = require_db2();
  }
});

// ../../../DeskThing-NPM/Server/node_modules/mime-types/index.js
var require_mime_types2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/mime-types/index.js"(exports2) {
    "use strict";
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/lib/defer.js
var require_defer2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/lib/defer.js"(exports2, module2) {
    module2.exports = defer;
    function defer(fn) {
      var nextTick = typeof setImmediate == "function" ? setImmediate : typeof process == "object" && typeof process.nextTick == "function" ? process.nextTick : null;
      if (nextTick) {
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/lib/async.js
var require_async2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/lib/async.js"(exports2, module2) {
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/lib/abort.js
var require_abort2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/lib/abort.js"(exports2, module2) {
    module2.exports = abort;
    function abort(state) {
      Object.keys(state.jobs).forEach(clean.bind(state));
      state.jobs = {};
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/lib/iterate.js
var require_iterate2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/lib/iterate.js"(exports2, module2) {
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/lib/state.js
var require_state2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/lib/state.js"(exports2, module2) {
    module2.exports = state;
    function state(list, sortMethod) {
      var isNamedList = !Array.isArray(list), initState = {
        index: 0,
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/lib/terminator.js
var require_terminator2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/lib/terminator.js"(exports2, module2) {
    var abort = require_abort2();
    var async = require_async2();
    module2.exports = terminator;
    function terminator(callback) {
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/parallel.js
var require_parallel2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/parallel.js"(exports2, module2) {
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/serialOrdered.js
var require_serialOrdered2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/serialOrdered.js"(exports2, module2) {
    var iterate = require_iterate2();
    var initState = require_state2();
    var terminator = require_terminator2();
    module2.exports = serialOrdered;
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/serial.js
var require_serial2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/serial.js"(exports2, module2) {
...
// ../../../DeskThing-NPM/Server/node_modules/asynckit/index.js
var require_asynckit2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/asynckit/index.js"(exports2, module2) {
    module2.exports = {
...
// ../../../DeskThing-NPM/Server/node_modules/form-data/lib/populate.js
var require_populate2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/form-data/lib/populate.js"(exports2, module2) {
    module2.exports = function(dst, src) {
      Object.keys(src).forEach(function(prop) {
        dst[prop] = dst[prop] || src[prop];
      });
...
// ../../../DeskThing-NPM/Server/node_modules/form-data/lib/form_data.js
var require_form_data2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/form-data/lib/form_data.js"(exports2, module2) {
...
// ../../../DeskThing-NPM/Server/node_modules/proxy-from-env/index.js
var require_proxy_from_env2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/proxy-from-env/index.js"(exports2) {
    "use strict";
    var parseUrl = require("url").parse;
    var DEFAULT_PORTS = {
      ftp: 21,
...
// ../../../DeskThing-NPM/Server/node_modules/follow-redirects/debug.js
var require_debug3 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/follow-redirects/debug.js"(exports2, module2) {
    var debug;
    module2.exports = function() {
      if (!debug) {
        try {
...
// ../../../DeskThing-NPM/Server/node_modules/follow-redirects/index.js
var require_follow_redirects2 = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/follow-redirects/index.js"(exports2, module2) {
    var url2 = require("url");
    var URL2 = url2.URL;
    var http2 = require("http");
    var https2 = require("https");
...
// ../../../DeskThing-NPM/Server/node_modules/axios/dist/node/axios.cjs
var require_axios = __commonJS({
  "../../../DeskThing-NPM/Server/node_modules/axios/dist/node/axios.cjs"(exports2, module2) {
    "use strict";
    ...
    var https2 = require("https");
    var util2 = require("util");
    var followRedirects2 = require_follow_redirects2();
    ...
    AxiosError4.from = (error, code, config, request, response, customProps) => {
      ...
      AxiosError4.call(axiosError, error.message, code, config, request, response);
        ...
        if (data && utils$1.isString(data) && (forcedJSONParsing && !this.responseType || JSONRequested)) {
          ...
          try {
            ...
            if (strictJSONParsing) {
              if (e.name === "SyntaxError") {
                throw AxiosError4.from(e, AxiosError4.ERR_BAD_RESPONSE, this, null, this.response);
              }
              throw e;
            }
          }
    ...
    function fromDataURI2(uri, asBlob, options) {
      ...
      if (protocol === "data") {
        ...
        if (!match) {
          throw new AxiosError4("Invalid URL", AxiosError4.ERR_INVALID_URL);
        }
        const mime = match[1];
        ...
        if (asBlob) {
          if (!_Blob) {
            throw new AxiosError4("Blob is not supported", AxiosError4.ERR_NOT_SUPPORT);
          }
          return new _Blob([buffer], { type: mime });
        }
        return buffer;
      }
      throw new AxiosError4("Unsupported protocol " + protocol, AxiosError4.ERR_NOT_SUPPORT);
    }
      ...
      return wrapAsync2(async function dispatchHttpRequest(resolve, reject, onDone) {
        ...
        if (protocol === "data:") {
          ...
          try {
            ...
            throw AxiosError4.from(err, AxiosError4.ERR_BAD_REQUEST, config);
          }
        ...
        if (supportedProtocols2.indexOf(protocol) === -1) {
          return reject(new AxiosError4(
            "Unsupported protocol " + protocol,
            AxiosError4.ERR_BAD_REQUEST,
            config
          ));
        }
        ...
        req = transport.request(options, function handleResponse(res) {
          ...
          if (responseType === "stream") {
            ...
            responseStream.on("error", function handleStreamError(err) {
              if (req.destroyed) return;
              reject(AxiosError4.from(err, null, config, lastRequest));
            });
            responseStream.on("end", function handleStreamEnd() {
              try {
                ...
                return reject(AxiosError4.from(err, null, config, response.request, response));
              }
              settle2(resolve, reject, response);
            });
          }
        ...
        req.on("error", function handleRequestError(err) {
          reject(AxiosError4.from(err, null, config, req));
        });
        ...
        if (config.timeout) {
          ...
          if (Number.isNaN(timeout)) {
            reject(new AxiosError4(
              ...
              AxiosError4.ERR_BAD_OPTION_VALUE,
              config,
              req
            ));
            return;
    ...
    var xhrAdapter = isXHRAdapterSupported2 && function(config) {
      return new Promise(function dispatchXhrRequest(resolve, reject) {
        ...
        request.onerror = function handleError() {
          reject(new AxiosError4("Network Error", AxiosError4.ERR_NETWORK, config, request));
          request = null;
        };
    ...
    var composeSignals2 = (signals, timeout) => {
      ...
      let timer = timeout && setTimeout(() => {
        onabort(new AxiosError4(`timeout ${timeout} of ms exceeded`, AxiosError4.ETIMEDOUT));
      }, timeout);
      const unsubscribe = () => {
        if (signals) {
    ...
    var trackStream2 = (stream5, chunkSize, onProgress, onFinish, encode4) => {
      const iterator = readBytes2(stream5, chunkSize, encode4);
      let bytes = 0;
      let done;
      let _onFinish = (e) => {
        if (!done) {
    ...
    var supportsRequestStream2 = isReadableStreamSupported2 && test(() => {
    ...
    var supportsResponseStream2 = isReadableStreamSupported2 && test(() => utils$1.isReadableStream(new Response("").body));
    var resolvers2 = {
    ...
    isFetchSupported2 && ((res) => {
      ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((type) => {
        !resolvers2[type] && (resolvers2[type] = utils$1.isFunction(res[type]) ? (res2) => res2[type]() : (_, config) => {
          throw new AxiosError4(`Response type '${type}' is not supported`, AxiosError4.ERR_NOT_SUPPORT, config);
        });
      });
    })(new Response());
      ...
      getAdapter: (adapters2) => {
        ...
        for (let i = 0; i < length; i++) {
          ...
          if (!isResolvedHandle2(nameOrAdapter)) {
            ...
            if (adapter === void 0) {
              throw new AxiosError4(`Unknown adapter '${id}'`);
            }
          }
          if (adapter) {
            break;
...
// ../../../DeskThing-NPM/Server/dist/index.js
var require_dist = __commonJS({
  "../../../DeskThing-NPM/Server/dist/index.js"(exports2) {
    "use strict";
...
var SpotifyHandler = class {
  ...
  async refreshAccessToken() {
    ...
    try {
      const response = await axios_default(authOptions);
      this.DeskThing.sendLog("Access token refreshed!");
      const access_token = response.data.access_token;
      this.DeskThing.saveData({ access_token });
  ...
  async login() {
    ...
    const auth_url = `https://accounts.spotify.com/authorize?response_type=code&client_id=${this.Data.client_id}&scope=${scope}&redirect_uri=${this.Data.redirect_uri}&state=${state}`;
  ...
  async handleError(error) {
    try {
      ...
      this.DeskThing.sendError(`There was an error in spotify's ErrorHandler ${error2}`);
    }
  }
  /**
   ...
   */
  async makeRequest(method, url2, data = null, attempt = 0) {
    if (this.DeskThing.stopRequested) return;
    this.DeskThing.sendLog(`Handling request to url ${url2}`);
    try {
      if (!this.Data.client_id || !this.Data.client_secret) {
        this.DeskThing.sendError("No client_id or client_secret! Cancelling refresh access token request!");
      ...
      try {
        const response = await axios_default({ method, url: url2, data, headers });
        ...
        if (attempt < 8) {
          this.DeskThing.sendLog("Retrying! Attempt #" + attempt + " " + method + url2 + data);
          const retryResponse = await this.makeRequest(method, url2, data, attempt + 1);
  ...
  async getCurrentPlayback() {
    const url2 = `${this.BASE_URL}`;
    return this.makeRequest("get", url2);
  }
  async getCurrentEpisode() {
    const url2 = `${this.BASE_URL}?additional_types=episode`;
    return this.makeRequest("get", url2);
  }
  async next(id = "") {
    const url2 = `${this.BASE_URL}/next`;
    await this.makeRequest("post", url2);
    return await this.returnSongData(id);
  }
  async previous() {
    const url2 = `${this.BASE_URL}/previous`;
    await this.makeRequest("post", url2);
  ...
  async play(context) {
    ...
    return this.makeRequest("put", url2, body);
  }
  async pause() {
    const url2 = `${this.BASE_URL}/pause`;
    return this.makeRequest("put", url2);
  }
  async seek(position) {
    const url2 = `${this.BASE_URL}/seek?position_ms=${position}`;
    return this.makeRequest("put", url2);
  }
  async like(state) {
    ...
    if (trackInfo && trackInfo.item.id) {
      ...
      const url2 = `${this.BASE_URL}/me/tracks?ids=${id}`;
      if (state) {
        return this.makeRequest("put", url2);
      } else {
        return this.makeRequest("delete", url2);
      }
    }
  }
  async volume(newVol) {
    const url2 = `${this.BASE_URL}/volume?volume_percent=${newVol}`;
    return this.makeRequest("put", url2);
  }
  async repeat(state) {
    if (state == "all") {
      const url3 = `${this.BASE_URL}/repeat?state=context`;
      return this.makeRequest("put", url3);
    }
    const url2 = `${this.BASE_URL}/repeat?state=${state}`;
    return this.makeRequest("put", url2);
  }
  async shuffle(state) {
    const url2 = `${this.BASE_URL}/shuffle?state=${state}`;
    return this.makeRequest("put", url2);
  }
  async transfer() {
    try {
  ...
  async transferPlayback(deviceId) {
    ...
    await this.makeRequest("put", url2, body);
  }
...
var spotify_default = SpotifyHandler;
