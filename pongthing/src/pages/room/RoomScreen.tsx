    ...
    <div className="bg-black text-white min-h-screen w-full p-2 sm:p-4 md:p-8 overflow-auto">
      <div className="max-w-7xl mx-auto">
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 auto-rows-min">
          {/* Players List */}
          <div className="bg-gray-800 p-3 sm:p-4 md:p-6 rounded-lg overflow-y-auto max-h-[80vh] sm:max-h-[600px]">
            <div className="flex justify-between items-center border-b mb-2 pb-1">
              <h1 className="text-xl sm:text-2xl md:text-3xl truncate font-bold">
          ...
          {/* Game Info & Controls */}
          <div className="bg-gray-800 p-3 sm:p-4 md:p-6 rounded-lg  max-h-[80vh] sm:max-h-[600px]">
            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-4">Game Status</h2>
