        ...
        <div className="bg-slate-800 w-screen h-screen flex justify-center items-center">
            {imageData ? (
                ...
                <div className="flex items-center justify-center flex-col">
                    ...
                    <button disabled={loading} className="p-4 flex items-center disabled:bg-neutral-800 transition-colors disabled:text-zinc-200 bg-neutral-700 rounded-lg mt-5 text-4xl text-white text-semibold" onClick={handleRequestImage}>
                        <p className="mr-2">Request Image</p>
                        {loading && <div className="animate-spin border-t-2 w-10 h-10 rounded-full" />}
                    </button>
